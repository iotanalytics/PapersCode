...
/*
  ...
  Parameters:
    ...
    Input, float T[N*3], contains the nonsymmetric matrix.  Its
    ...
    Input/output, float E[N].  On input, E(2:N) contains the
    ...
    Input/output, float Z[N*M], contains the eigenvectors.
...
/*
  ...
  Parameters:
    ...
    Input, float SCALE[N], contains information determining
    the permutations and scaling factors used by BALANC.

    Input, int M, the number of columns of Z to be
    back-transformed.

    Input/output, float Z[N*M], contains the real and imaginary 
...
/*
  ...
  Parameters:
    ...
    Input/output, float A[N*MB].  On input, contains the lower
    ...
    Output, float D[N], the diagonal elements of the tridiagonal
    matrix.

    Output, float E[N], the subdiagonal elements of the tridiagonal
    matrix in E(2:N).  E(1) is set to zero.

    Output, float E2[N], contains the squares of the corresponding
    ...
    Output, float Z[N*N], the orthogonal transformation matrix
...
/*
  ...
  Parameters:
    ...
    Input, float SCALE[N], information determining the permutations
    and scaling factors used by CBAL.

    Input, int M, the number of eigenvectors to be back
    transformed.

    Input/output, float ZR[N*M], ZI[N*M].  On input, the real
...
/*
  ...
  Parameters:
    ...
    Input, float XR, XI, the real and imaginary parts of the 
    quantity whose square root is desired.

    Output, float *YR, *YI, the real and imaginary parts of the 
    square root.
*/
{
  float s;
  ...
  tr = xr;
  ti = xi;
  s = sqrt ( 0.5 * ( pythagoras ( tr, ti ) + r8_abs ( tr ) ) );
...
/*
  ...
  Parameters:
    ...
    Input, float A, B, the two legs of a right triangle.

    Output, float PYTHAG, the length of the hypotenuse.
*/
{
  float p;
  float r;
...
/*
  ...
  Parameters:
    ...
    Output, float R8MAT_MM[N1*N3], the product matrix C = A * B.
*/
{
  float *c;
  int i;
...
/*
  ...
  Parameters:
    ...
    Input, float A[N*N], the real symmetric matrix.

    Input, int MATZ, is zero if only eigenvalues are desired, 
    and nonzero if both eigenvalues and eigenvectors are desired.

    Output, float W[N], the eigenvalues in ascending order.

    Output, float Z[N*N], contains the eigenvectors, if MATZ
    is nonzero.
...
*/
{
  ...
  if ( matz == 0 )
  {
    fv1 = ( float * ) malloc ( n * sizeof ( float ) );
    fv2 = ( float * ) malloc ( n * sizeof ( float ) );
...
/*
  ...
  Parameters:
    ...
    Input, float A[N*MB], contains the lower triangle of the real
...
/*
  ...
  Parameters:
    ...
    Input/output, float D[N].  On input, the diagonal elements of
    ...
    Input, float Z[N*N].  On input, the transformation matrix
...
int tqlrat ( int n, float d[], float e2[] )
...
/*
  ...
  Parameters:
    ...
    Input/output, float D[N].  On input, D contains the diagonal
    ...
    Input/output, float E2[N], contains in positions 2 through N 
...
void tred1 ( int n, float a[], float d[], float e[], float e2[] )
...
/*
  ...
  Parameters:
    ...
    Input/output, float A[N*N], on input, contains the real
    ...
    Output, float D[N], contains the diagonal elements of the
    tridiagonal matrix.

    Output, float E[N], contains the subdiagonal elements of the
...
/*
  ...
  Parameters:
    ...
    Input, float A[N*N], the real symmetric input matrix.  Only the
