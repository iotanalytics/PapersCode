...
[tfrComplex, ifd, tfrtic, Stime] = STFT_IFD_fast(x, fr/fs, hop, h2, Dh2);
...
[~, tfrsq] = synchrosqueeze1win(tfrComplex, ifd, fr/fs, h2, num_s, fr, HighFreq, fs, ths, 'Smooth', Smo, 'Reject', Rej);
