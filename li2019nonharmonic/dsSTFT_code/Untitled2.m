...
advTF.Smo = 0.1; % alpha smoothing; 1 = no smoothing
advTF.Rej = 0; % The bandwidth of window rejection; 
advTF.ths = 1E-9; % Global threshold of STFT
advTF.HighFreq = 4/basicTF.fs; % highest frequency/sampling freq
...
subplot(221)
plot(0:1/basicTF.fs:1/basicTF.fs*(size(x)-1),x,'k','linewidth',1.5); axis([0 inf -10000 10000]) %colormap(1-gray);
